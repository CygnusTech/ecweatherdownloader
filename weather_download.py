...
if __name__ == "__main__":
  ...
  for siteconfig in WeatherDownloaderConfig.sites:
    ...
    print("Timezone: "+str(localTimezone.zone))
    print("UTC Offset: "+str(localTimezone.utcoffset(datetime.datetime.now())))
    print("NowUTC: "+str(endDateUTC))
    print("NowLocal: "+str(endDateLocal))
    print("Output timezone: "+str(outTimezone.zone))
    print()
